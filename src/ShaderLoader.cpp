...
ShaderLoader::ShaderLoader(void) : programID(0), vertexShaderID(0), fragmentShaderID(0), colAttrib(0), posAttrib(0) {
}
...
void ShaderLoader::use(void) {
	glUseProgram(this->programID);
}


void ShaderLoader::unuse(void) {
	glUseProgram(0);
}
